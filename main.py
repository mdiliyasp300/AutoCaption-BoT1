...
try: app_id = int(os.environ.get("app_id", "28494431"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "381dff361d5a3d03645b626b906c7afe")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7664032176:AAGxYPejZ8sKRqRM_-MAHpIOADJ_AnC2HO0")
